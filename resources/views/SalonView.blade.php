...
@foreach($data as $data1)
    <head>
        ...
        <title>Salon({{$data1->Salon_Name}})-Evora</title>
        <!-- Bootstrap CSS -->
					...
					<div class="container box_1620">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            ...
                            <li class="nav-item">
								...
								<img src="/uploads/salon/{{$data1->Profile_Pic}}" style="width:32px; height:32px; border-radius: 50%;" >
								{{ Auth::user()->name }} 
                                </a>
							...
							<div class="media-body">
								<div class="row">
									<div class="column offset-1">
										...
										<li><a href="files/salon/{{$dec1->Pdf}}"><img src="images/pdf.png" width="40" hight="40" alt="" ></a></li>
                                    	<ul>
									</div>
								</div>
        	...
        	<div class="container">
				...
				<form class="form-horizontal" method="POST" action="{{URL('/AddRating'.$data1->userid)}}" enctype="multipart/form-data">
					...
					<div class="form-group" id="rating-ability-wrapper">
						...
						<span class="field-label-header">What is the rating you are wish to give to this Bridal and Groom Designer?</span><br>
