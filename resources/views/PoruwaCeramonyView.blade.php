...
@foreach($data as $data1)
    ...
    <head>
        ...
        <title>Poruwa Ceramony({{$data1->Name}})-Evora</title>
        <!-- Bootstrap CSS -->
    ...
    <body>
					...
					<div class="container box_1620">
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item">
								...
								<img src="/uploads/poruwa/{{$data1->Main_pic}}" style="width:32px; height:32px; border-radius: 50%;" >
								{{ Auth::user()->name }} 
                                </a>
        ...
        <section class="home_banner_area">
           	...
           	<div class="container box_1620">
               <div class="offset-3">
               <h1>Poruwa Rituals<h1>
               </div>
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img src="uploads/poruwa/{{$data1->Main_pic}}" width="500" hight="800" alt="">
							</div>
        	...
        	<div class="container">
        		...
        		<div class="feature_inner row">
                    @if($data1->Poruwa_rituals=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/poru1.jpg"  width="300" height="200 ">
                                <br><br>
                                <h4>Poruwa Rituals</h4>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($data1->Poruwa_items=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/poru2.jpg"  width="300" height="200 ">
                                <br><br>
                                <h4>Poruwa Items</h4>
                            </div>
                        </div>
                    ...
                    @if($data1->match_making=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/poru3.jpg"  width="300" height="200 ">
                                <br><br>
                                <h4>Match Making</h4>
                            </div>
                        </div>
                    ...
                    @if($data1->Astrological_support=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/poru4.jpg"  width="300" height="200 ">
                                <br><br>
                                <h4>Astrological Support</h4>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($data1->jayamangala_gatha=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/poru5.jpg"  width="300" height="200 ">
                                <br><br>
                                <h4>Jayamangala Gatha</h4>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($data1->Wedding_dancers=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/poru6.jpg"  width="300" height="200 ">
                                <br><br>
                                <h4>Wedding Dancers</h4>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="main_title">
					    ...
					    <div class="row">
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/poruwa/{{$data1->pic1}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInBottom">
                                <div class="project" >
                                    <img src="uploads/poruwa/{{$data1->pic2}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/poruwa/{{$data1->pic3}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/poruwa/{{$data1->pic4}}" alt="IMage" class="img-fluid">
                                </div>
                            </div>
                        </div>
					</div>
							...
							<div class="media-body">
								<div class="row">
                                    ...
                                    <li><b>Price :- </b> Rs.{{$dec1->Price}}</li>
										<li><a href="files/poruwa/{{$dec1->Pdf}}"><img src="images/pdf.png" width="40" hight="40" alt="" ></a></li>
