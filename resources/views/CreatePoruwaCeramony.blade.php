                ...
                <div class="card-body">
                    <form method="POST" action="/addPoruwa" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name='Description' cols='50' rows='5' id='Description' class="form-control @error('Address') is-invalid @enderror"></textarea>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="form-group row{{ $errors->has('Cost') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Cost" type="number" min="0" class="form-control @error('Cost') is-invalid @enderror" name="Cost" value="{{ old('Cost') }}"  autocomplete="Cost" >
