...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/designer3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/designer7.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/designer4.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
    ...
    <div class="topnav">
    <form method="get" action="/CostumeDesignerSearch" enctype="multipart/form-data">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mx-auto text-center mb-5 section-heading">
            <h2 class="mb-5">Our Costume Designers</h2>
          </div>
        </div>
        ...
        <div class="site-block d-lg-flex">
          <div class="col-md-7 col-lg-4">
            <a href="uploads/costume/{{$leve->Main_pic}}" class="image-popup img-opacity"><img src="uploads/costume/{{$leve->Main_pic}}" alt="Image" class="img-fluid"></a>
          </div>
          <div class="text">
            <br>
            <h2 > {{$leve->Name}}</h2>
            ...
            <p><a href="{{URL('/CostumeDesignerView'.$leve->id)}}" class=""><button class="btn btn-danger ">View More <span class="icon-arrow-right small"></button></span></a></p>          
          </div>
        </div>
        <br><br><br>
        @endforeach
