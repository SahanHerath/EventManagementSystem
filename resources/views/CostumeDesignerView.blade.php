...
@foreach($data as $data1)
    ...
    <body>
					...
					<div class="container box_1620">
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item">
								...
								<img src="/uploads/costume/{{$data1->Main_pic}}" style="width:32px; height:32px; border-radius: 50%;" >
								{{ Auth::user()->name }} 
                                </a>
        ...
        <section class="home_banner_area">
           	...
           	<div class="container box_1620">
               <div class="offset-3">
               <h1>Costume Designers<h1>
               </div>
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img src="uploads/costume/{{$data1->Main_pic}}" width="500" hight="800" alt="">
							</div>
        		...
        		<div class="feature_inner row">
        			...
        			<div class="col-lg-4 col-md-6">
        				<div class="feature_item">
        					<img src="images/coswedding1.jpg"  width="300" height="200 ">
                            <br><br>
        					<h4>Wedding</h4>
                            @if($data1->wedding_dress_designs == "Available")
                            Wedding Dress Designs<br>
                            @endif
        			...
        			<div class="col-lg-4 col-md-6">
        				<div class="feature_item">
                            <img src="images/cosparty.jpg"  width="300" height="200 ">
                            <br><br>
        					<h4>Parties</h4>
                            @if($data1->clothing_orders == "Available")
                                Clothing Order<br>
        			...
        			<div class="col-lg-4 col-md-6">
        				<div class="feature_item">
                        <img src="images/cosfashion.jpg"  width="300" height="200 ">
                            <br><br>
        					<h4>Fashion Show</h4>
        			...
        			<div class="col-lg-4 col-md-6">
        				<div class="feature_item">
                        <img src="images/cossport.jpg"  width="300" height="200 ">
                            <br><br>
        					<h4>Sports</h4>
        			...
        			<div class="col-lg-4 col-md-6">
        				<div class="feature_item">
                        <img src="images/coscoop.jpg"  width="300" height="200 ">
                            <br><br>
        					<h4>Coperate Events</h4>
                    ...
                    <div class="main_title">
					    ...
					    <div class="row">
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/costume/{{$data1->pic1}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInBottom">
                                <div class="project" >
                                    <img src="uploads/costume/{{$data1->pic2}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/costume/{{$data1->pic3}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/costume/{{$data1->pic4}}" alt="IMage" class="img-fluid">
                                </div>
                            </div>
                        </div>
					</div>
        	...
        	<div class="container">
				...
				<form class="form-horizontal" method="POST" action="{{URL('/AddRating'.$data1->userid)}}" enctype="multipart/form-data">
					...
					<div class="form-group" id="rating-ability-wrapper">
						...
						<span class="field-label-header">What is the rating you are wish to give to this Costume Designer?</span><br>
