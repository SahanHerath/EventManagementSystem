...
@foreach($data as $data1)
    <head>
        ...
        <title>Actor({{$data1->Actor_name}})-Evora</title>
        <!-- Bootstrap CSS -->
           	...
           	<div class="container box_1620">
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img src="uploads/actor/{{$data1->Main_pic}}" width="500" hight="800" alt="">
							</div>
        		...
        		<div class="feature_inner row">
        			...
        			<div class="col-lg-4 col-md-6">
        				<div class="feature_item">
                            ...
                            <span class="lnr lnr-checkmark-circle"></span>Party
                            @endif
                            <br>
                            @if($data1->Professional_event == "Available")
                            <span class="lnr lnr-checkmark-circle"></span>Professional Event
                            @endif
                            <br>
                            @if($data1->Musical_event == "Available")
                            <span class="lnr lnr-checkmark-circle"></span>Musical Event
                            @endif
                            <br>
                            @if($data1->Corporate_event == "Available")
                            <span class="lnr lnr-checkmark-circle"></span>Corporate Event
                            @endif
                            <br>
                    ...
                    <div class="main_title">
					    ...
					    <div class="row">
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/actor/{{$data1->pic1}}" alt="IMage" class="img-fluid" >
                                    <br><br><br>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInBottom">
                                <div class="project" >
                                    <img src="uploads/actor/{{$data1->pic2}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/actor/{{$data1->pic3}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/actor/{{$data1->pic4}}" alt="IMage" class="img-fluid">
                                </div>
                            </div>
                        </div>
					</div>
							...
							<div class="media-body">
								<div class="row">
									<div class="column offset-1">
										<ul class="list basic_info">
										<li><b>Hours :- </b>{{$dec1->Hours}}</li>
                                    <li><b>Services :- </b>{{$dec1->Services}}</li>
                                    <li><b>Price :- </b> Rs.{{$dec1->Price}}</li>
										<li><a href="files/actor/{{$dec1->Pdf}}"><img src="images/pdf.png" width="40" hight="40" alt="" ></a></li>
        	...
        	<div class="container">
				...
				<form class="form-horizontal" method="POST" action="{{URL('/AddRating'.$data1->userid)}}" enctype="multipart/form-data">
					...
					<div class="form-group" id="rating-ability-wrapper">
						...
						<span class="field-label-header">What is the rating you are wish to give to this Artist?</span><br>
