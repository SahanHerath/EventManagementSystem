            	...
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container box_1620">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            ...
                            <li class="nav-item active"><i class="fa fa-eye" style="font-size:24px"></i><a class="nav-link" href="{{URL('/DanceView'.$data1->userid)}}">View Your Profile</a></li> 
                            
                            <li class="nav-item active"><a class="nav-link" href="#">
                                    <p class="text-white"><img src="/uploads/dancing/{{$data1->Main_pic}}" style="width:32px; height:32px; border-radius: 50%;" >
                                    {{ Auth::user()->name }}</p>
                                </a>
                            </li>  
                        ...
                        <div class="personal_text" >
                            <div class="col-lg-4 col-md-6" style="border: 5px solid red;">
                                <div class="feature_item">
                                    ...
                                    <ul class="list basic_info">
                                    <a class="genric-btn primary" href="#" data-toggle="modal" data-target="#modalEditPackage" data-pakid="{{$deto1->id}}" data-packagename="{{$deto1->Package_Name}}" data-price="{{$deto1->Price}}" data-services="{{$deto1->Services}}" data-dancingtype="{{$deto1->Dancing_Type}}">Edit</a></center>
...
<div class="modal fade" id="mainpicchange" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <center><img src="uploads/dancing/{{$data1->Main_pic}}" alt="User Avatar" width="200" hight="200"></center>
                    
                    <form enctype="multipart/form-data" action="{{URL('/ChangeDancerMainpic'.$data1->dancerid)}}"  method="POST">
            ...
            <div class="modal-content">
                ...
                <table class="table table hover table-bordered">
                       ...
                       <tbody>
                            ...
                            <tr>
                                <td> <img src="/uploads/dancing/{{$data1->pic1}}" class="img-rounded" style="border: 2px solid black; width:150px; height:150px; float:left;  margin-right:25px;"></td>
                                <td>
                                
                                <form enctype="multipart/form-data" action="{{URL('/dancerpic1'.$data1->dancerid)}}" method="POST">
                            ...
                            <tr>
                                <td> <img src="/uploads/dancing/{{$data1->pic2}}" class="img-rounded" style="border: 2px solid black; width:150px; height:150px; float:left;  margin-right:25px;"></td>
                                <td>
                                
                                <form enctype="multipart/form-data" action="{{URL('/dancerpic2'.$data1->dancerid)}}" method="POST">
                                <label>Update This Image</label>
                            ...
                            <tr>
                                <td> <img src="/uploads/dancing/{{$data1->pic3}}" class="img-rounded" style="border: 2px solid black; width:150px; height:150px; float:left;  margin-right:25px;"></td>
                                <td>
                                
                                <form enctype="multipart/form-data" action="{{URL('/dancerpic3'.$data1->dancerid)}}" method="POST">
                                <label>Update This Image</label>
                            ...
                            <tr>
                                <td> <img src="/uploads/dancing/{{$data1->pic4}}" class="img-rounded" style="border: 2px solid black; width:150px; height:150px; float:left;  margin-right:25px;"></td>
                                <td>
                                
                                <form enctype="multipart/form-data" action="{{URL('/dancerpic4'.$data1->dancerid)}}" method="POST">
                                <label>Update This Image</label>
  ...
  <div class="modal fade" id="modalAddPackage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{URL('/AddDancerPackage'.$data1->userid)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group row{{ $errors->has('Dancing_Type') ? ' has-error' : '' }}">
                        <label for="Dancing_Type" class="col-md-4 col-form-label offset-1">Dancing Type :-</label>
...
<div class="modal fade" id="modalEditPackage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{URL('/EditDancerPackage')}}" method="post">
      		{{csrf_field()}}
	      <div class="modal-body">
                ...
                <div class="form-group">
		        	<label for="Dancing_Type1">Dancing Type</label>
		        	<input type="text" class="form-control" name="Dancing_Type1" id="Dancing_Type1">
	        	</div>
...
<!-- Modal -->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="{{URL('/DeleteDancerPackage')}}" method="post">
      		{{csrf_field()}}
	      <div class="modal-body">
 ...
 <div class="modal fade" tabindex="-1" role="dialog" id="modalDeleteVideo" >
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="{{URL('/DeleteDancerVideo')}}" method="post">
      		{{csrf_field()}}
	      <div class="modal-body">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  $('#modalEditPackage').on('show.bs.modal', function (event) {
      ...
      var dancingtype = button.data('dancingtype') 
      ...
      modal.find('.modal-body #Dancing_Type1').val(dancingtype);
