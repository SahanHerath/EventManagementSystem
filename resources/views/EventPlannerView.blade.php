...
@foreach($data as $data1)
    <head>
        ...
        <title>EventPlanners({{$data1->Organization_name}})-Evora</title>
        <!-- Bootstrap CSS -->
					...
					<div class="container box_1620">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            ...
                            <li class="nav-item">
								...
								<img src="/uploads/event/{{$data1->Main_pic}}" style="width:32px; height:32px; border-radius: 50%;" >
								{{ Auth::user()->name }} 
                                </a>
               ...
               <h1>Event Planners<h1>
           		...
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img src="uploads/event/{{$data1->Main_pic}}" width="500" hight="800" alt="">
							</div>
        	...
        	<div class="container">
        		...
        		<div class="feature_inner row">
                    @if($data1->Wedding=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/plan0.jpg"  width="300" height="200 ">
                                <br><br>
                                <h4>Wedding</h4>
                            </div>
                        </div>
                    ...
                    @if($data1->Parties=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/plan4.jpg"  width="300" height="200 ">
                                <br><br>
                                <h4>Parties</h4>
                            </div>
                        </div>
                    ...
                    @if($data1->Meetings=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/plan7.jpg"  width="300" height="200 ">
                                <br><br>
                                <h4>Meetings</h4>
                            </div>
                        </div>
                    ...
                    @if($data1->Corporate_event=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/plan5.jpg"  width="300" height="200 ">
                                <br><br>
                    ...
                    @if($data1->Outside_event=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/plan3.jpg"  width="300" height="200 ">
                                <br><br>
                    ...
                    @if($data1->Sport_event=="Available")
                        <div class="col-lg-4 col-md-6">
                            <div class="feature_item">
                                <img src="images/plan1.jpg"  width="300" height="200 ">
                                <br><br>
                                <h4>Sport Events</h4>
                            </div>
                        </div>
                    ...
                    <div class="main_title">
					    ...
					    <div class="row">
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/event/{{$data1->pic1}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInBottom">
                                <div class="project" >
                                    <img src="uploads/event/{{$data1->pic2}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/event/{{$data1->pic3}}" alt="IMage" class="img-fluid">
                                    <br><br><br>
                                </div>
                            </div>
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project">
                                    <img src="uploads/event/{{$data1->pic4}}" alt="IMage" class="img-fluid">
                                </div>
                            </div>
                        </div>
					</div>
							...
							<div class="media-body">
								<div class="row">
									<div class="column offset-1">
										...
										<li><a href="files/planner/{{$dec1->Pdf}}"><img src="images/pdf.png" width="40" hight="40" alt="" ></a></li>
										<ul>
									</div>
								</div>
        	...
        	<div class="container">
				...
				<form class="form-horizontal" method="POST" action="{{URL('/AddRating'.$data1->userid)}}" enctype="multipart/form-data">
					...
					<div class="form-group" id="rating-ability-wrapper">
						...
						<span class="field-label-header">What is the rating you are wish to give to this Event Planner?</span><br>
