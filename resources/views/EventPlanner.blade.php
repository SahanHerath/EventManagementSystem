...
<html lang="en">
  <head>
    <title>Evora-EventPlanner</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="slide-one-item home-slider owl-carousel">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              ...
              <h2 class="caption">Greatest Planners To Your Event </h2>
            </div>
          </div>
        </div>
      </div>  

      <div class="site-blocks-cover overlay" style="background-image: url(images/eplaner8.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/eplaner0.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/eplaner7.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <p class="mb-4">You are able to find best event planners for any of your special occasions.You can select Wedding,Parties,Meetings,Corporate event,Outside event,Sport event. </p>
            </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-5 upcoming-events" style="background-image: url('images/hero_1.jpg'); background-attachment: fixed;">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <h2 class="text-white">Are you a Professional Event Planner? Join with Us.</h2>
