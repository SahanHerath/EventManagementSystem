           	...
           	<div class="container">
           		<div class="banner_inner d-flex align-items-center">
					<div class="offset-1 banner_content">
						<div class="media">
                            <div class="d-flex">
                                <img src="images/salon4.jpg" width="400" hight="600" alt="">
                            </div>
                            ...
                            <h3>Organization Name</h3>
                                <ul class="list basic_info">
                                    ...
                                    <li><b>Contact_No :- </b>ContactNo here</li>
                    ...
                    <div class="section-top-border">
						...
						<div class="row gallery-item">
							<div class="col-md-3" width="400" hight="600">
								<a href="images/outside-events.jpg" class="img-gal"><div class="single-gallery-image" style="background: url(images/outside-events.jpg);"></div></a>
							</div>
							<div class="col-md-3">
								<a href="images/outside-events.jpg" class="img-gal"><div class="single-gallery-image" style="background: url(images/outside-events.jpg);"></div></a>
							</div>
