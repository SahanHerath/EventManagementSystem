                ...
                <div class="card-body">
                    <form method="POST" action="/addcatering" enctype="multipart/form-data">
                        ...
                        <div class="form-group row{{ $errors->has('Service_Name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Service_Name" type="text" class="form-control @error('Service_Name') is-invalid @enderror" name="Service_Name" value="{{ old('Service_Name') }}"  autocomplete="Service_Name" autofocus>
